...
class ProbeApp(ctk.CTk):
    ...
    def _build_sidebar(self, parent):
        ...
        self._dev_panel = ctk.CTkFrame(side, fg_color="transparent")
        
        self._sim_play_btn = ctk.CTkButton(
            self._dev_panel, text="⏸  Pause", width=56,
    ...
    def _on_simulate_data(self):
        ...
        self._dev_panel.pack(padx=16, pady=6)
        ...
        def _done(records, err):
            ...
            self._simulate_btn.pack(padx=16, pady=6)
